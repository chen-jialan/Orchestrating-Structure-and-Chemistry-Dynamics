...
extensions = [
    ...
    Extension(
        ...
        [
            ...
            "dscribe/ext/eann.cpp",  # eann jlchen
...
if __name__ == "__main__":
    setup(
        ...
        install_requires=['pybind11>=2.4', "numpy", "scipy",
                          "ase>=3.19.0", "scikit-learn", "joblib>=1.0.0", "sparse"],
        # This ensures that files defined in MANIFEST.in are included
